...
export function Sidebar() {
    ...
    return (
        <div className="hidden md:flex flex-col w-64 min-h-screen bg-card border-r border-border/50 sticky top-0 h-screen">
            <div className="p-6 border-b border-border/50 flex items-center gap-3">
                ...
                <div>
                    <h1 className="font-display font-bold text-lg tracking-tight">Vexis Log</h1>
                    <p className="text-xs text-muted-foreground font-medium">Trading Journal</p>
                </div>
            </div>

            <nav className="flex-1 p-4 space-y-2">
                <p className="px-4 text-xs font-semibold text-muted-foreground mb-4 mt-2">MENU</p>
